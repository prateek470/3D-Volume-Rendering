% While using affline transformation we have to use the 2D interpolation
% techniques........this file includes the interpolation of the
% images......it is made by using the C code of the Interpolation.....it
% includes lower interpolation....nearest, bilinear and bicubic....
function Iout = InterpoloImage(Iin,Tlocalx,Tlocaly,Interpolation,Boundary,ImageSize)
...
switch(lower(Interpolation))
    ...
    otherwise
        error('InterpoloImage:inputs','unknown interpolation method');
end
